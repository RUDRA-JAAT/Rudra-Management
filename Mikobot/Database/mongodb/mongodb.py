...
from Rudrabot import DB_NAME, LOGGER, MONGO_DB_URI

try:
    Rudrabot_db_client = MongoClient(MONGO_DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
Rudrabot_main_db = Rudrabot_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = Rudrabot_main_db[collection]
    ...
    @staticmethod
    def close():
        return Rudrabot_db_client.close()
