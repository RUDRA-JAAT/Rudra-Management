...
if ENV:
    ...
    DB_NAME = os.environ.get("DB_NAME", "RudraDB")
...
# <=============================================== CLIENT SETUP ========================================================>
# Create the Rudrabot and TelegramClient instances
app = Client("Rudrabot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
